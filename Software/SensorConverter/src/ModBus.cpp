...
float ModBusRTU_Class::GetRegisterOutputData(uint16_t index, uint8_t register_type){
	...
	//if(index > (sizeof(this->RegisterMap[RegisterType])/sizeof(this->RegisterMap[RegisterType][0]))){
	if(index > 7){
		return 0;
	}
